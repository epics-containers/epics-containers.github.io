...
set of restrictions that mitigate this issue. See {any}`argus` for details
of the remote worker nodes and suggestions for secure configuration.

[kubernetes cni providers]: https://rancher.com/blog/2019/2019-03-21-comparing-kubernetes-cni-providers-flannel-calico-canal-and-weave/
